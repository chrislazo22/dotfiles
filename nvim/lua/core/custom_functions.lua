function _G.search_replace()
	...
	local success, err = pcall(function()
		...
		-- Clear the command line and ask for replacement
		vim.cmd("redraw")
		...
		-- Clear the command line and ask for confirmation
		vim.cmd("redraw")
		local confirm = vim.fn.input(string.format("Replace '%s' with '%s'? (y/n): ", word, replace))
		...
		-- Turn off the search highlight after the operation
